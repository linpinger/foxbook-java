...
- 2016-11-13: 修改: 超时时间 15s 改为 5s
- 2016-05-29: 添加: 更新所有先更新书架
- 2016-05-04: 添加: 命令行模式依次更新命令，针对一些慢速网站多线程更新失效的问题
- 2016-04-11: 添加: 命令行模式更新所有书，转mobi/epub/txt，突然发现多线程下载代码重复，这还是多线程消息队列问题，头疼，暂时先放着吧，反正能用
